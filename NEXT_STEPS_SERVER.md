...
### Настройка мобильного приложения для подключения к серверу:

Мобильное приложение уже настроено для подключения к серверу `212.74.227.208:3000`.
...
**Подробная инструкция:** См. `MOBILE_APP_SETUP.md`
...
- [ ] Мобильное приложение настроено и протестировано
